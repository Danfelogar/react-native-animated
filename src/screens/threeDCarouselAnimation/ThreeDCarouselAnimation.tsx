...
export const ThreeDCarouselAnimation = () => {
      ...
      <SafeAreaView style={{marginTop: SPACING * 4}}>
        <View style={{height: IMAGE_HEIGHT * 2.1}}>
          ...
          <View
            ...
            {DATA.map((item, index) => {
              const inputRange = [
                //representa el rango es decir desde un 20% que el view se mueva este comenzara a ser opaco
                (index - 0.2) * width,
                index * width,
                (index + 0.2) * width,
              ];
